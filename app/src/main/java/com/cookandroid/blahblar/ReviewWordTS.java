...
public class ReviewWordTS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogView_3 = (View) View.inflate(ReviewWordTS.this,R.layout.dialog, null);
        ...
        add_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(ReviewWordTS.this);
                dlg.setTitle("단어 추가");
