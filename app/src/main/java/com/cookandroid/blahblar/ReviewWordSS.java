...
public class ReviewWordSS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialogView_3 = (View) View.inflate(ReviewWordSS.this,R.layout.dialog, null);
        ...
        add_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(ReviewWordSS.this);
                dlg.setTitle("단어 추가");
