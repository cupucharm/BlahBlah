...
public class VideoLearnActivity extends AppCompatActivity {
    ...
    double[] stop_time = {27, 40, 56, 59, 69, 76, 83};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(this, id + " " + name + " " + phone + " " + today+" "+title, Toast.LENGTH_LONG).show();
        today = intent.getExtras().getString("today");
        Log.d("비디오피카..", id+ " " + name+" "+phone+" "+today);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            if(txtSpeechInput.getText().toString()!=null){
                ...
                todaytime = sdf.format(date);

                ReviewVO review = new ReviewVO();
                UserVO user = new UserVO();
                user.setId(id);
                review.setTitle(title);
                review.setTodaytime(todaytime);
                review.setWsent(txtSpeechInput.getText().toString());
                Log.d("review 만들기..", review.getId()+"/" +review.getTitle()+"/" +review.getTodaytime()+"/" +review.getWsent());
