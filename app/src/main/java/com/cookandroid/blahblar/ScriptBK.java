...
public class ScriptBK extends AppCompatActivity {
    ...
    ArrayList<String> bkList;
    String selectedBK;


    String BKPath = Environment.getExternalStorageDirectory().getPath()+"/BK/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        File[] listFiles=new File(BKPath).listFiles();
        ...
        listViewMP3=(ListView)findViewById(R.id.listscript);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, bkList);
        ...
        listViewMP3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                selectedBK = bkList.get(arg2);
            }
        });

        selectedBK = bkList.get(0);
        ...
        btnReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    mediaPlayer.setDataSource(BKPath + selectedBK);
                    Log.d("대체뭐가재생", BKPath + selectedBK);
                    mediaPlayer.prepare();;
                    mediaPlayer.start();
