...
public class ReviewWordIT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //예시
        eng_3.add("retirement");
        kor_3.add("은퇴");
        eng_3.add("ongoing");
        kor_3.add("계속 진행 중인");
        eng_3.add("dress up ");
        kor_3.add("변장을 하다");
        eng_3.add("congeniality");
        kor_3.add("일치, 친화성 적합성");
        ...
        dialogView_3 = (View) View.inflate(ReviewWordIT.this,R.layout.dialog, null);
        ...
        add_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(ReviewWordIT.this);
                dlg.setTitle("단어 추가");
