...
public class ScriptBS extends AppCompatActivity {
    ...
    String BSPath = Environment.getExternalStorageDirectory().getPath()+"/BS/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        File[] listFiles=new File(BSPath).listFiles();
        ...
        listViewMP3=(ListView)findViewById(R.id.listscript);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, bsList);
        ...
        listViewMP3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                selectedBS = bsList.get(arg2);
            }
        });

        selectedBS = bsList.get(0);
        ...
        btnReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    mediaPlayer.setDataSource(BSPath + selectedBS);
                    Log.d("대체뭐가재생", BSPath + selectedBS);
                    mediaPlayer.prepare();;
                    mediaPlayer.start();
