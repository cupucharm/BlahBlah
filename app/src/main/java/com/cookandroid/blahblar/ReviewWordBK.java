...
public class ReviewWordBK extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //예시
        eng_3.add("boarding");
        kor_3.add("길게 잇댄 판자, 기숙");
        eng_3.add("backward");
        kor_3.add("퇴보하는, 발전이 더딘");
        eng_3.add("Splash");
        kor_3.add("끼얹다, 철벅 떨어지다");
        eng_3.add("bury");
        kor_3.add("묻다, 여의다");
        ...
        dialogView_3 = (View) View.inflate(ReviewWordBK.this,R.layout.dialog, null);
        ...
        add_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(ReviewWordBK.this);
                dlg.setTitle("단어 추가");
