...
public class ScriptMP extends AppCompatActivity {
    ...
    String MPPath = Environment.getExternalStorageDirectory().getPath()+"/MP/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        File[] listFiles=new File(MPPath).listFiles();
        ...
        listViewMP3=(ListView)findViewById(R.id.listscript);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, mpList);
        ...
        listViewMP3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                selectedMP = mpList.get(arg2);
            }
        });

        selectedMP = mpList.get(0);
        ...
        btnReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    mediaPlayer.setDataSource(MPPath + selectedMP);
                    Log.d("대체뭐가재생", MPPath + selectedMP);
                    mediaPlayer.prepare();;
                    mediaPlayer.start();
