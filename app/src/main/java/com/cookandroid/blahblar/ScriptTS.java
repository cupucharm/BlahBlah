...
public class ScriptTS extends AppCompatActivity {
    ...
    String TSPath = Environment.getExternalStorageDirectory().getPath()+"/TS/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        File[] listFiles=new File(TSPath).listFiles();
        ...
        listViewMP3=(ListView)findViewById(R.id.listscript);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, tsList);
        ...
        listViewMP3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                selectedTS = tsList.get(arg2);
            }
        });

        selectedTS = tsList.get(0);
        ...
        btnReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    mediaPlayer.setDataSource(TSPath + selectedTS);
                    Log.d("대체뭐가재생", TSPath + selectedTS);
                    mediaPlayer.prepare();;
                    mediaPlayer.start();
