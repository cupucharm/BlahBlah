...
public class ScriptIT extends AppCompatActivity {
    ...
    ArrayList<String> itList;
    String selectedIT;


    String ITPath = Environment.getExternalStorageDirectory().getPath()+"/IT/";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        itList =new ArrayList<String>();

        File[] listFiles=new File(ITPath).listFiles();
        ...
        listViewMP3=(ListView)findViewById(R.id.listscript);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, itList);
        ...
        listViewMP3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                selectedIT = itList.get(arg2);
            }
        });

        selectedIT = itList.get(0);
        ...
        btnReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    mediaPlayer.setDataSource(ITPath + selectedIT);
                    Log.d("대체뭐가재생", ITPath + selectedIT);
                    mediaPlayer.prepare();;
                    mediaPlayer.start();
