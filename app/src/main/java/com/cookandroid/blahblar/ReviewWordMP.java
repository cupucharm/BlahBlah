...
public class ReviewWordMP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //예시
        eng_3.add("commitment");
        kor_3.add("약속, 전념, 헌신");
        eng_3.add("cologne");
        kor_3.add("오드콜로뉴(연한 향수의 일종)");
        eng_3.add("perplex");
        kor_3.add("당혹하게 하다");
        eng_3.add("killjoy");
        kor_3.add("남의 흥을 깨는 사람");
        eng_3.add("smoky");
        kor_3.add("연기가 자욱한");
        ...
        dialogView_3 = (View) View.inflate(ReviewWordMP.this,R.layout.dialog, null);
        ...
        add_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(ReviewWordMP.this);
                dlg.setTitle("단어 추가");
