...
public class ScriptGP extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listViewMP3=(ListView)findViewById(R.id.listscript);
        ArrayAdapter<String> adapter=new ArrayAdapter<String>(this, android.R.layout.simple_list_item_single_choice, gpList);
        ...
        listViewMP3.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                selectedGP = gpList.get(arg2);
            }
        });

        selectedGP = gpList.get(0);
        ...
        btnReplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try{
                    ...
                    mediaPlayer.setDataSource(GPPath + selectedGP);
                    Log.d("대체뭐가재생", GPPath + selectedGP);
                    mediaPlayer.prepare();;
                    mediaPlayer.start();
